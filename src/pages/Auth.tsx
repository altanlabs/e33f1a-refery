...
export default function Auth() {
  const { session, service, loading } = useAuth();
  ...
  const handleSignIn = async (e: React.FormEvent) => {
    ...
    try {
      const { error } = await service.signIn(signInData.email, signInData.password);
        ...
        <Card className="shadow-2xl">
          <CardHeader className="space-y-1">
            <div className="flex items-center justify-center mb-4">
              <div className="h-8 w-8 rounded bg-emerald-600 mr-2 flex items-center justify-center">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          onChange={(e) => setSignUpData(prev => ({ ...prev, surname: e.target.value }))}
                          className="pl-10"
                          required
                        />
                      </div>
