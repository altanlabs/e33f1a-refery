...
// AuthWrapper component that provides the exact same interface as altan-auth
        ...
        <form onSubmit={handleSignIn} className="space-y-4">
          <div>
            ...
            <input
              ...
              required
              className="w-full px-3 py-3 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 dark:bg-gray-800 dark:text-white"
        ...
        <form onSubmit={handleSignUp} className="space-y-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-3 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 dark:bg-gray-800 dark:text-white"
            >
              <option value="referrer">Referrer - Earn by referring candidates</option>
              <option value="candidate">Candidate - Find job opportunities</option>
              <option value="poster">Company - Post jobs and hire talent</option>
            </select>
          </div>
